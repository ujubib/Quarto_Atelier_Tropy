# Autour du standard IIIF {.unnumbered}
 ...
 **IIIF** (**I***nternational* **I***mage* **I***nteroperability* **F***ramework*™) est un ensemble de standards qui définissent un cadre d’interopérabilité pour la diffusion des images numériques sur le Web. 
  ...
  **IIIF** permet la manipulation homogène d'images indépendamment de leurs localisations physiques et des établissements qui les hébergent. (utilisé notamment sur Europeana[^europ] , Gallica[^gallica], Nakala, de nombreux serveurs Omeka…)
...
[^europ]: [Europeana IIIF APIs](https://pro.europeana.eu/page/iiif)

[^gallica]: [API IIIF de récupération des images de Gallica](https://api.bnf.fr/fr/api-iiif-de-recuperation-des-images-de-gallica)
...
- [Publier une image avec ses annotations : utilisation de Tesselle en histoire de l’art](https://numrha.hypotheses.org/1019) - Antoine Courtin (_Numérique et recherche en histoire de l'art_, 2020).
